<style>
    ...
    .card-overlay {
        ...
        color: white; /* Using the green theme color */
    }
    ...
    .destination-card img {
        ...
        object-fit: cover; /* Cover ensures the image fills the card */
    }
    ...
    .destination h1, .destination h6 {
        color: #28a745; /* Using the green theme color */
    }
</style>
            ...
            @foreach($packages as $package)
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.{{ $loop->iteration }}s">
                    <div class="destination-card">
                        ...
                        @endauth
                                <img class="img-fluid w-100" src="{{ asset('storage/' . $image) }}" alt="{{ $package->name }}">
